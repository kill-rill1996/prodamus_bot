...
def subscribe_message() -> str:
    ...
    message = "Вы оформляете ежемесячную подписку на закрытый канал с ежедневным питанием от Шевы.\n\n" \
              "Кроме рецептов на каждый день вы узнаете, как белки, жиры и углеводы помогают похудеть.\n\n" \
              "А ещё в канале мы проводим розыгрыши и челенджи.\n\n" \
              f"<b>Важно</b>: сначала подключится тестовый период на {settings.trial_period} дня за 1 рубль. По истечении {settings.trial_period} дней автоматически подключится стандартная подписка. Это только для новых пользователей.\n\n"\
              "💰<b>Стоимость: 29 руб/день</b>\n<i>*890 руб/месяц</i>\n\n" \
              "Подпишитесь на канал и вы уже не сможете двигаться по жизни без моих ежедневных рецептов, как не можете ездить без музыки в машине.\n\n" \
